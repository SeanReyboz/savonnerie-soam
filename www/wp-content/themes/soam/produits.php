      ...
      <div class="soap">
        ...
        <div class="soap_window">
          ...
          <button type="button" name="dendelion">
            <img src="" alt="Le savon Dendelion">
            <h3>Dendelion</h3>
          </button>

          <button type="button" name="sativa">
            <img src="" alt="Le savon Sativa">
            <h3>Sativa</h3>
          </button>

          <button type="button" name="yemanjah">
            <img src="" alt="Le savon Yemanjah">
            <h3>Yemanjah</h3>
          </button>

          <button type="button" name="rebelle">
            <img src="" alt="Le savon le Rebelle">
            <h3>Le Rebelle</h3>
          </button>

          <button type="button" name="kaoline">
            <img src="" alt="Le savon Kaoline">
            <h3>Kaoline</h3>
          </button>
